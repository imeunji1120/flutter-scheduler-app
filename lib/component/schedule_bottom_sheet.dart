...
class _ScheduleBottomSheetState extends State<ScheduleBottomSheet> {
                ...
                child: Column(
                  children: [
                    _Time(
                      ...
                      onSEndValidate: onEndTimeValidate,
  ...
  String? onContentSaved(String? val) {
    if (val == null) {
      // return;
    }
...
class _Time extends StatelessWidget {
  ...
  final FormFieldValidator<String> onSEndValidate;
...
typedef OnColorSelecred = void Function(int color);

class _Categories extends StatelessWidget {
  final int selectedColor;
  final OnColorSelecred onTap;
