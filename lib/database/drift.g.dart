...
class $CategoryTableTable extends CategoryTable
  ...
  static const VerificationMeta _randomNumber2Meta = const VerificationMeta(
    'randomNumber2',
  );
  @override
  ...
  CategoryTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CategoryTableData(
      ...
      randomNumber2:
          attachedDatabase.typeMapping.read(
            DriftSqlType.int,
            data['${effectivePrefix}random_number2'],
          )!,
      createdAt:
          attachedDatabase.typeMapping.read(
...
class CategoryTableData extends DataClass
  ...
  CategoryTableCompanion toCompanion(bool nullToAbsent) {
    return CategoryTableCompanion(
      ...
      color: Value(color),
      randomNumber:
          randomNumber == null && nullToAbsent
              ? const Value.absent()
              : Value(randomNumber),
  ...
  CategoryTableData copyWithCompanion(CategoryTableCompanion data) {
    return CategoryTableData(
      ...
      randomNumber:
          data.randomNumber.present
              ? data.randomNumber.value
              : this.randomNumber,
      randomNumber2:
          data.randomNumber2.present
