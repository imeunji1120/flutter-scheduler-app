...
import '../model/schedule_with_category.dart';
    ...
    return MigrationStrategy(
      onUpgrade: (Migrator m, int from, int to) async {
        if (from < 2) {
          await m.addColumn(
            categoryTable,
            categoryTable.randomNumber as GeneratedColumn<Object>,
          );
        }
        ...
        if (from < 3) {
          await m.addColumn(
            categoryTable,
            categoryTable.randomNumber2 as GeneratedColumn<Object>,
          );
        }
      },
    );
